...
public class SearchResultPage extends TestBase {
	...
	public ArrayList<String> verifySorting() {

		ArrayList<String> ObtainedPriceList = new ArrayList<String>();

		for (WebElement we : productPrice) {

			ObtainedPriceList.add(we.getText());
		}

		Collections.sort(ObtainedPriceList);
		return ObtainedPriceList;
